 ...
 * 命令确认 QuickPick 适配器。
 *
 * 把 agentpack-coding 的 PermissionManager.confirmFn 接到 VSCode QuickPick：
...
import type { ConfirmContext, ConfirmResult } from 'agentpack-coding';
