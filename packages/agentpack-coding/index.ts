/**
 * agentpack-coding —— agentpack coding 工具集 + coding agent 工厂 + CLI
 *
 * 双形态对外：
...
// ─── 从 agentpack 再导出常用类型（方便单一 import） ───────────────────
export type { Tool, ToolResult, Extension, ContextTransformer, StreamFn } from 'agentpack';
