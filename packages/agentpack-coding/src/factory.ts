 ...
 * 参考 agentpack-cli/src/runtime.ts 的模型解析与 createRuntime 装配模式。
 *
 * 可选 memory 选项动态 import agentpack-memory（避免硬依赖）。
 *
 * 用法：
