...
- **位置**：[config.json:13](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L13)、[schema.ts:78](file:///Users/peroluo/work/ai/nanobot-main-ts/src/config/schema.ts#L78)、[runner.ts:134](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L134)
...
- **现状代码**：循环到 `maxIterations - 1` 时还会 push 一条 `buildGoalContinueMessage()`（[runner.ts:323](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L323)），等于变相鼓励继续。

#### 2. 每轮 LLM 调用都重发全部 30+ 工具 schema
- **位置**：[runner.ts:142](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L142)、[openai_compat_provider.ts:234](file:///Users/peroluo/work/ai/nanobot-main-ts/src/providers/openai_compat_provider.ts#L234)
...
#### 3. 历史消息原样重发，无主动截断
- **位置**：[loop.ts:299-316](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/loop.ts#L299)、[loop.ts:141](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/loop.ts#L141)
...
- **位置**：[helpers.ts:39-41](file:///Users/peroluo/work/ai/nanobot-main-ts/src/utils/helpers.ts#L39)、[context_governance.ts:418-430](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts#L418)
...
#### 5. 会话压缩阈值过晚 + 粗暴切片
- **位置**：[manager.ts:188, 223-238](file:///Users/peroluo/work/ai/nanobot-main-ts/src/session/manager.ts#L223)
...
- **位置**：[context_governance.ts:16](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts#L16)
...
- **位置**：[autocompact.ts:44-94](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/autocompact.ts#L44)
...
- **位置**：[subagent.ts:116-117](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/subagent.ts#L116)、[subagent.ts:84](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/subagent.ts#L84)
...
- **问题**：
  ...
  ```
  触发后会 push `'The conversation is too long. Please summarize...'` 消息（[runner.ts:172](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L172)），反而增加 token。
- **影响**：限流时非但不退避，还多塞一条 user 消息继续请求，可能加重限流。

#### 10. WebUI 每个新会话额外调用 LLM 生成标题
- **位置**：[webui_turns.ts:84-150](file:///Users/peroluo/work/ai/nanobot-main-ts/src/session/webui_turns.ts#L84)
...
- **位置**：[context.ts:73-92](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context.ts#L73)
- **问题**：`getDefaultIdentity` 已经写了 `Current time: ...`，`getRuntimeContext` 又写一遍 `Current date and time: ...`，重复占用 token。

#### 12. Dream 模式每 2 小时后台跑 LLM
- **位置**：[config.json:104-110](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L104)
...
- **位置**：[manager.ts:66-75](file:///Users/peroluo/work/ai/nanobot-main-ts/src/session/manager.ts#L66)
...
#### 14. 空响应/截断重试机制累加消息
- **位置**：[runner.ts:198-204, 215-222](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L198)
...
- **位置**：[runner.ts:144-163](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L144)
...
- **位置**：[config.json:22](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L22)
- **问题**：每个对话独立会话，每次都重新建立 system prompt + 工具认知。对于个人助手场景，跨对话共享上下文可省 token。

#### 17. `max_tokens: 8192` 输出 token 上限偏高
- **位置**：[config.json:9](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L9)
- **问题**：单次输出最多 8K tokens，配合 200 次迭代，最坏输出 = 1.6M tokens。多数任务 1K~2K 输出已足够。

#### 18. `tool_hint_max_length` 等次要配置
- **位置**：[config.json:18](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L18)
...
- **位置**：[registry.ts:99-105](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/tools/registry.ts#L99)
- **问题**：每次工具调用都 push 到 `executionHistory`，无清理。虽然不直接计入 LLM token，但长期运行会导致内存占用。`clearHistory()` 存在但少有调用。

#### 20. Backfill 占位消息累积
- **位置**：[context_governance.ts:18, 183-228](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts#L183)
...
- **位置**：[config.json:11](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json#L11)
...
- **配套**：在 [runner.ts:323](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L323) 接近上限时不再 push `buildGoalContinueMessage`，改为 push `'You are approaching the iteration limit. Wrap up now.'`。
...
| 模块 | 文件 |
|------|------|
| Agent 主循环 | [src/agent/runner.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts) |
| 上下文构建 | [src/agent/context.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context.ts) |
| 上下文治理 | [src/agent/context_governance.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts) |
| 会话管理 | [src/session/manager.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/session/manager.ts) |
| 自动压缩 | [src/agent/autocompact.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/autocompact.ts) |
| 工具注册 | [src/agent/tools/registry.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/tools/registry.ts) |
| 子代理 | [src/agent/subagent.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/subagent.ts) |
| 主入口 | [src/agent/loop.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/loop.ts) |
| Token 估算 | [src/utils/helpers.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/utils/helpers.ts#L39) |
| 默认配置 | [.nanobot/config.json](file:///Users/peroluo/work/ai/nanobot-main-ts/.nanobot/config.json) |
| 配置 schema | [src/config/schema.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/config/schema.ts) |
| OpenAI 兼容 provider | [src/providers/openai_compat_provider.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/providers/openai_compat_provider.ts) |
| WebUI 标题生成 | [src/session/webui_turns.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/session/webui_turns.ts) |
...
- **位置**：[registry.ts:91-97](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/tools/registry.ts#L91)
- **触发时机**：每次工具执行完毕，结果返回前
...
- **位置**：[runner.ts:169-177](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L169)、[runner.ts:215-222](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L215)
...
- **关键问题**：
  ...
  4. **`isLengthError` 误把 429 / rate limit 当作长度错误**（[runner.ts:371](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L371)），限流时非但不退避，还多塞消息。
...
- **位置**：[context_governance.ts:45-60](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts#L45)
- **设计意图**（看代码非常完整）：
  ```
...
- **位置**：[autocompact.ts:27](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/autocompact.ts#L27)
- **设计意图**：
...
- **位置**：[context_governance.ts:16, 72-86](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/context_governance.ts#L16)
...
- **位置**：[registry.ts:119-121](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/tools/registry.ts#L119)
...
3. **整改 #5、#7 的真正做法应是「接入 ContextGovernor / AutoCompact」**，而非重新设计：
   - 在 [runner.ts:142](file:///Users/peroluo/work/ai/nanobot-main-ts/src/agent/runner.ts#L142) 调用 LLM 前，插入 `contextGovernor.prepareForModel(config, messages, compactedToolCallIds)`；
   - 在 [nanobot.ts](file:///Users/peroluo/work/ai/nanobot-main-ts/src/nanobot.ts) 启动时实例化 `AutoCompact`，挂载到 `SessionManager`，并设置定时器或 TTL。
